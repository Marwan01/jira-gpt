...
describe('DashboardGadgetEdit', () => {
    it('renders correctly', async () => {
        const noop = () => { };
        expect(await (0, __1.render)(__1.default.createElement(__1.DashboardGadgetEdit, { onSubmit: noop },
    ...
    it('calls onSubmit callback when Save button is clicked', async () => {
        ...
        await (0, __1.render)(__1.default.createElement(__1.DashboardGadgetEdit, { onSubmit: onSubmitMock },
